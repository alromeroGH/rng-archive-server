    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/admin/characterBanner/create").hasAnyRole("ADMIN")
                        ...
                        .requestMatchers("/api/admin/weaponBanner/create").hasAnyRole("ADMIN")
                        .requestMatchers("/api/admin/weaponBanner").hasAnyRole("ADMIN", "USER")
                        .requestMatchers("/api/admin/weaponBanner/update/{id}").hasAnyRole("ADMIN")
                        .requestMatchers("/api/admin/weaponBanner/delete/{id}").hasAnyRole("ADMIN")
                        .requestMatchers("/api/admin/news/create").hasAnyRole("ADMIN")
                        .requestMatchers("/api/admin/news").hasAnyRole("ADMIN", "USER")
                        .requestMatchers("/api/admin/news/update/{id}").hasAnyRole("ADMIN")
                        .requestMatchers("/api/admin/news/delete7{id}").hasAnyRole("ADMIN")
                        .requestMatchers("/api/admin/artifactSet/create").hasAnyRole("ADMIN")
                        .requestMatchers("/api/admin/artifactSet").hasAnyRole("ADMIN", "USER")
                        .requestMatchers("/api/admin/artifactSet/update/{id}").hasAnyRole("ADMIN")
                        .requestMatchers("/api/admin/artifactSet/delete/{id}").hasAnyRole("ADMIN")
                        .requestMatchers("/api/admin/unit/create").hasAnyRole("ADMIN")
                        .requestMatchers("/api/admin/unit").hasAnyRole("ADMIN", "USER")
                        .requestMatchers("/api/admin/unit/update/{id}").hasAnyRole("ADMIN")
                        .requestMatchers("/api/admin/unit/delete/{id}").hasAnyRole("ADMIN")
